...
# Fix SCRIPT_DIR to point to project root (up one level from micro_X_v6/)
SCRIPT_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
LOG_DIR = "logs"
CONFIG_DIR = "config"
LOG_FILE = os.path.join(SCRIPT_DIR, LOG_DIR, "micro_x_v6.log") # Use separate log
...
def load_configuration_early():
    ...
    if base_config is None:
        logger.critical(f"CRITICAL ERROR: Default configuration file not found: {default_config_path}")
        sys.exit(1)
