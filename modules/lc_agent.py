...
async def run_agent(human_query: str) -> tuple[str | None, str | None]:
    ...
    # TODO: Get this from config via MCP
    max_cycles = 2 # config_param.get('behavior', {}).get('translation_validation_cycles', 2)
    final_state = None
