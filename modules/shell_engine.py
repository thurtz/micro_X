...
class ShellEngine:
    ...
    async def submit_user_input(self, user_input: str, from_edit_mode: bool = False):
        ...
        INTENT_COMMAND_MAP = {
            ...
            "command_add": "/utils command --add",
            "command_remove": "/utils command --remove",
            "command_move": "/utils command --move",
            ...
            "snapshot_include_full_module": "/utils generate_snapshot --include-full-module",
            "snapshot_help": "/utils generate_snapshot --help",
            "alias_list": "/utils alias --list",
            "alias_add": "/utils alias --add",
            "alias_remove": "/utils alias --remove",
            ...
            "list_scripts_by_name": "/utils list_scripts --name",
