...
class RouterService:
    ...
    async def route_input(self, user_input: str) -> str:
        ...
        prompt = (
            ...
            "Categories:\n"
            "- SHELL: A request to perform a system action, file operation, or run a command.\n"
            "- DOCS: A question about how to use micro_X, its features, setup, or specific internal utilities.\n"
            ...
            "Input: 'how do I change the model' -> DOCS\n\n"
            f"Input: \"{user_input}\"\n\n"
