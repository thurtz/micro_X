...
1. # Main Branch (Stable):    git clone [https://github.com/thurtz/micro](https://github.com/thurtz/micro)\_X.git micro\_X-main \# default branch    cd micro\_X-main git checkout main \# Usually already on main by default    ./setup.sh \# Run setup within this directory
