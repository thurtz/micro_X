...
* **Required Ollama Models (Examples \- these are configurable):**  
  * Pull via ollama pull \<model\_name\>  
...
3. Make the appropriate setup script executable (e.g., chmod \+x setup\_micro\_x\_mint.sh).  
4. Run the Setup Script (e.g., ./setup\_micro\_x\_mint.sh).  
