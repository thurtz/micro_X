...
TRANSLATION_VALIDATION_CYCLES = 2 # How many times to try getting a validated translation
...
async def get_validated_ai_command(human_query: str) -> tuple[str | None, str | None]:
    ...
    last_raw_candidate = None # Store the raw candidate from the first successful regex match by _interpret_and_clean_ai_output
