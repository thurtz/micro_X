...
# Script to set up the micro_X environment on Arch Linux
# MODIFIED to use Poetry for dependency management

echo "--- micro_X Setup Script for Arch Linux (OS-Specific) ---"
echo ""
...
# --- 1. Prerequisites ---
echo "--- Checking Prerequisites (using pacman) ---"

# First, refresh package databases
...
if [ -n "$PACKAGES_TO_INSTALL" ]; then
    ...
    echo "Attempting to install with pacman (may require sudo)..."
...
# --- 6. Setup Complete ---
echo "--- Arch Linux Setup for micro_X Complete! ---"
echo ""
echo "To run micro_X:"
...
necho "4. Run the main Python script: python3 main.py"
echo ""
echo "------------------------------------------"
