...
from .output_analyzer import is_tui_like_output

from .router_agent import create_router_agent, run_router_agent
...
class ShellEngine:
    ...
    async def submit_user_input(self, user_input: str, from_edit_mode: bool = False):
        ...
        INTENT_COMMAND_MAP = {
            ...
            "dev_snapshot_all": ("/dev --snapshot-all", False),
            "dev_run_tests_main": ("/dev --run-tests-main", False),
            "dev_run_tests_testing": ("/dev --run-tests-testing", False),
